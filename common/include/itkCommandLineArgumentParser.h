...
protected:
  ...
  /** Provide an overload for std::string, since the general StringCast
...
private:
  CommandLineArgumentParser( const Self & ) = delete; // purposely not implemented
